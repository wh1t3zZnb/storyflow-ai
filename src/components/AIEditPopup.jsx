...
export default function AIEditPopup({ isOpen, onClose, onSubmit, targetName }) {
  ...
  return (
    <div className="glass-panel" style={{ position: 'absolute', right: '40px', top: 0, zIndex: 50, width: '320px', padding: '16px', boxShadow: '0 10px 25px -5px rgba(0,0,0,0.1)' }}>
      ...
      <p className="text-secondary" style={{ fontSize: '12px', marginBottom: '8px' }}>
        正在修改: <span style={{ color: 'var(--text-primary)', fontWeight: 500 }}>{targetName}</span>
      </p>
